...
func _process(delta: float) -> void:
	...
	attack_eat_anim.set("parameters/conditions/Attacking", _target_in_range())
	attack_eat_anim.set("parameters/conditions/Walking", !_target_in_range())	# follow the player
